...
BOT_TOKEN = "8150895425:AAE1XAs0HyFt47k1ZgD3H0fNLt0V2Tj-xHY"
...
def send_welcome(message):
    ...
    if c.fetchone():
        ...
        return_photo = "https://graph.org/file/1f0b433f5ed109a29eed1-c705cfa8a799cd69b3.jpg"
        return_caption = "𝗛𝗘𝗬 𝗧H𝗘𝗥𝗘 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗕𝗔𝗖𝗞!\n\nI'м [˹ 𝗧ᴇᴀм ✘ 𝗚ᴘт ˼](https://t.me/TEAM_X_GPT_ROBOT) 🌟\nHow Cᴀɴ ι Hᴇʟᴘ You?\n\nTʏᴘᴇ /help To Sᴇᴇ How To Usᴇ Mᴇ!"
    ...
    if free_users >= MAX_FREE_USERS and not premium_referral:
        limit_photo = "https://graph.org/file/c1e9651525a14a4674e3f-6d1b0aa8557a108c83.jpg"
        limit_caption = "Usᴇʀ Lιмιт Rᴇᴀcнᴇᴅ. Gᴇт ᴀ Pʀᴇмιuм Usᴇʀ's Rᴇғᴇʀʀᴀʟ Lιɴκ To Joιɴ!\n\n [𝗦нᴀʀᴇ](https://t.me/{bot.get_me().username}?start={user_id})"
    ...
    if referrer_id:
        ...
        if new_count >= 5:
            ...
            congrats_photo = "https://graph.org/file/7cf9e9e7825ae53f23e70-bba988b143b3878d91.jpg"
    ...
    welcome_photo = "https://graph.org/file/1f0b433f5ed109a29eed1-c705cfa8a799cd69b3.jpg"
...
def show_status(message):
    ...
    if user_data:
        ...
        photo_url = "https://graph.org/file/06bd520593fa701763c37-e08b5f90b29d4ab86e.jpg"
